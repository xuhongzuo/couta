...
This script is used to generate synthetic datasets with point anomalies.
"""
...
class MultivariateDataGenerator:
    ...
    def point_global_outliers(self, dim_no, ratio, factor, radius, start_percentage=0.6):
        """
        ...
        Args:
            ...
            start_percentage:
        """
        position = int(start_percentage*self.STREAM_LENGTH) + \
    ...
    def point_contextual_outliers(self,dim_no, ratio, factor, radius, start_percentage=0.6):
        """
...
if __name__ == '__main__':
    ...
    multivariate_data.point_global_outliers(
        dim_no=0, ratio=0.003, factor=3, radius=5
    )
    multivariate_data.point_contextual_outliers(
        dim_no=0, ratio=0.003, factor=3, radius=30
    )

    # # training contamination
    # multivariate_data.point_global_outliers(
    #     dim_no=0, ratio=0.001, factor=3, radius=5, start_percentage=0.,
    # )
    # multivariate_data.point_contextual_outliers(
    #     dim_no=0, ratio=0.001, factor=3, radius=30, start_percentage=0.,
    # )
    ...
    # save
    df.to_csv('~/dataset/5-TSdata/_experiment_data/synthetic_point.csv')

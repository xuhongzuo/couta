"""
This script is adapted from source code of TODS [NeuraIPS 21]
This script is used to generate synthetic datasets with collective anomalies.
"""
...
if __name__ == '__main__':
    ...
    multivariate_data.collective_seasonal_outliers(
        dim_no=0, ratio=0.02, factor=3, radius=5
    )
    # multivariate_data.collective_trend_outliers(
    #     dim_no=0, ratio=0.05, factor=0.1, radius=20
    # )
    ...
    # save
    df.to_csv('~/dataset/5-TSdata/_experiment_data/synthetic_collective.csv')
